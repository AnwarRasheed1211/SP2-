...
import { listAll, ref, getDownloadURL } from "firebase/storage"; // Corrected the import
...
export default function Gallery() {
  ...
  return (
    <div>
      <h1>Gallery</h1>
      <div style={{ display: "flex", flexDirection: "row", flexWrap: "wrap" }}> {/* Added flexWrap for better layout */}
